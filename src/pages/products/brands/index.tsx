...
import SidebarAddBrandDrawer from 'src/views/products/brand/list/SidebarAddBrandDrawer'
import { BrandTypes } from '../../../types/apps/brandTypes'
...
const BrandList = () => {
  ...
  const store = useSelector((state: RootState) => state.brands)
  ...
  const toggleAddCategoryDrawer = () => setAddBrandOpen(!addBrandOpen)
  ...
  return (
    <Grid container spacing={6.5}>
      ...
      <SidebarAddBrandDrawer open={addBrandOpen} toggle={toggleAddCategoryDrawer} />
    </Grid>
  )
}
